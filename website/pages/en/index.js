...
const Features = (props) => (
    <Block layout='fourColumn'>
        {[
            ...
            {
                content:
                    'Can be easily integrated with almost any workflow as it uses babel-plugin for strings extraction. Can be easily used with the [typescript](docs/typescript.html).',
...
const FeatureCallout = (props) => (
    ...
    >
        ...
        <MarkdownBlock>
            Gettext is a simple localization format with the rich ecosystem. Ttag has support for plurals, contexts,
            translator comments and much more.
        </MarkdownBlock>
    </div>
);
